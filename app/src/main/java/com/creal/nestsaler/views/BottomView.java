...
public class BottomView extends LinearLayout {
    ...
    private void setListener(){
        mScanMenu.setOnClickListener(new OnClickListener() {
        ...
        mSettingMenu.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
        ...
        mUpdatingMenu.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
        ...
        mAboutUsMenu.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
